...
const PortfolioContactCard: React.FC<contactmap> = ({ desc, title, parent, child1, child2, child3, child4, child5, child6, child }) => {
    ...
    return (
        <div className="flex  p-4 m-4  ">
            <div>
                <div className='text-black font-bold text-3xl mb-2 sm:text-base md:text-lg  lg:text-xl xl:text-2xl'>{title}</div>
            ...
            <div className=''>
                <div className='text-black font-bold text-3xl mb-2 sm:text-base md:text-lg lg:text-xl xl:text-2xl'>{parent}</div>
